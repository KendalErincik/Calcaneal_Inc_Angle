...
**Try it in the browser (no install):** https://foot.radiologymate.com
Upload a lateral weight-bearing foot radiograph (DICOM/PNG/JPG); the four landmarks
(P1-P4) and the CIA are returned. Uploaded images are processed in temporary storage
and deleted automatically; nothing is retained.
